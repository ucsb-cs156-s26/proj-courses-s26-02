...
describe("CourseOverTimeDescriptionIndexPage tests", () => {
  ...
  test("renders the correct title", () => {
    ...
    expect(
      screen.getByRole("heading", {
        name: /UCSB Course Description History Search/i,
      }),
    ).toBeInTheDocument();
  });
  ...
  test("calls UCSB Course description search api correctly with 3 section response", async () => {
    ...
    userEvent.type(enterSearchTerms, "algorithms");
  ...
  test("renders CourseOverTimeDescriptionSearchForm component", () => {
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <CourseOverTimeDescriptionIndexPage />
  ...
  test("renders ConvertedSectionTable component", () => {
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <CourseOverTimeDescriptionIndexPage />
    ...
    userEvent.selectOptions(selectEndQuarter, "20222");
    const enterSearchTerms = screen.getByLabelText("Search Terms");
    userEvent.type(enterSearchTerms, "test");
